...
# -*- coding: utf-8 -*-
"""
License_Analysis_Dashboard_20250613_150236.html を修正するスクリプト
"""
...
def generate_corrected_dashboard():
    """修正されたHTMLダッシュボードを生成"""
...
{user_table_content}
    ...
    <div class="footer">
        ...
        <p>修正済み - {datetime.now().strftime('%Y年%m月%d日 %H:%M:%S')} - 🤖 Generated with Claude Code</p>
    </div>
</body>
</html>'''
...
if __name__ == "__main__":
    print("🔧 License_Analysis_Dashboard_20250613_150236.html を修正中...")
    
    html_content = generate_corrected_dashboard()
    
    # 元ファイルを上書き
    output_path = '/mnt/e/MicrosoftProductManagementTools/Reports/Monthly/License_Analysis_Dashboard_20250613_150236.html'
    
    with open(output_path, 'w', encoding='utf-8') as file:
        file.write(html_content)
    
    print(f"✅ ダッシュボードが正常に修正されました: {output_path}")
    print("📊 修正内容:")
    print("   - 月額総コストカードを削除")
    print("   - 年間節約可能額カードを削除")
    print("   - ライセンス利用率カードを追加")
    print("   - 詳細なライセンス内訳を表示")
    print("   - コスト効率性メーターを削除")
    print("   - 正確な統計情報に更新")